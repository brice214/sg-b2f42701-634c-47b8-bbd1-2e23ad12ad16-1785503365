...
export default function Realisations() {
  const projects = [
    ...
    },
    {
      ...
      results: ["500+ utilisateurs actifs", "40% de conversion", "99.9% uptime"],
      icon: Globe,
    },
    {
      title: "Application Mobile Banking",
      category: "Développement Mobile",
      description: "App mobile sécurisée pour transactions bancaires avec authentification biométrique",
      image: "https://images.unsplash.com/photo-1563986768609-322da13575f3?w=800&q=80",
      technologies: ["React Native", "Firebase", "Biométrie"],
      results: ["10,000+ téléchargements", "4.8/5 étoiles", "Sécurité maximale"],
      icon: Smartphone,
    },
    {
