...
export default function EmailsProfessionnels() {
  ...
  const advantages = [
    ...
    },
    {
      ...
      description: "Planifiez réunions et événements avec votre équipe",
    },
    {
      icon: FileText,
      title: "Gestion Documentaire",
      description: "Partagez et collaborez sur vos documents professionnels",
    },
    {
      icon: Video,
      title: "Visioconférence",
      description: "Réunions en ligne intégrées directement dans votre messagerie",
    },
    {
      icon: Zap,
